...
const WISH_KEYWORDS = {
  "美妆护肤": ["口红", "面膜", "护肤", "粉底", "精华", "面霜", "香水", "眼影", "水乳", "防晒", "洗面奶", "卸妆"],
  "数码家电": ["手机", "耳机", "充电", "电脑", "平板", "相机", "电视", "冰箱", "洗衣机", "键盘", "鼠标", "音响", "投影", "手表", "充电宝", "显示器", "吸尘器"],
  "服饰鞋包": ["鞋", "衣服", "外套", "裙子", "裤子", "包", "帽", "袜", "卫衣", "羽绒", "连衣裙", "t恤", "牛仔裤", "卫裤", "风衣", "衬衫", "凉鞋", "靴"],
  "食品生鲜": ["零食", "饮料", "咖啡", "牛奶", "水果", "坚果", "巧克力", "面包", "茶叶", "饼干", "酸奶", "牛肉", "鸡肉", "海鲜", "燕麦"],
  "家居日用": ["杯", "收纳", "床", "枕", "桌", "椅", "灯", "窗帘", "毛巾", "锅", "碗", "香薰", "拖把", "牙刷", "被子", "四件套", "地毯"],
  "母婴宠物": ["婴儿", "宝宝", "奶粉", "尿不湿", "猫", "狗", "宠物", "玩具", "猫粮", "狗粮", "猫砂"],
  "运动户外": ["瑜伽", "跑步", "健身", "球", "哑铃", "跳绳", "露营", "帐篷", "骑行", "泳", "登山", "羽毛球", "护膝"]
};
